...
- Instalar Docker.
- Necessário cadastrar credenciais gmail.
...
resources:
  - name: consonants
    ...
    dialect: schemas/dialect_v1.json
  - name: vowels
    title: Vogais
...
frictionless validade datapackage.yaml
```
